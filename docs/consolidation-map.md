...
| 16 | finx-mockup | `index.html#/docs/glue/journey-onboarding` | Customer onboarding and KYC journey | `index.html#/docs/glue/journey-onboarding` | Auth | Migrated 30 May 2026 | P0 | Augmented with Onboarding Journey Map content from row 31. Staged across 3 commits (overview + BIAN mapping; per-step detail; saga + configurability). |
...
| 23 | finx-onboarding-docs | `docs/executive/brief.md` | Executive Brief — FinX Client Onboarding | `index.html#/executive-brief` | Public | Migrated 29 May 2026 | P0 | New marketing-adjacent route. Linked from `/resources`. Open question 2 resolved: own route. |
