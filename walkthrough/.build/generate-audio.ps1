...
$scenes = @(
  @{ id = "01-intro"; text = "Hi, welcome to a four minute walkthrough of the proposed UST FinX documentation portal. The mockup is live at finx dash mockup dot vercel dot app. I will cover the public marketing layer, the documentation layer for developers and bank operators, and the internal hub for UST staff. I will also explain how the three tiers are structured. And where the authentication question fits." },
